...
clean:
	rm -f simfs simfstest inode.o free.o mkfs.o image.o block.o  pack.o ls.o test_file simfs_test.osimfs.a

simfs.a: image.o block.o inode.o free.o mkfs.o pack.o ls.o
	ar rcs $@ $^
